...
export function AppHub() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <main className="w-full min-w-0 overflow-x-hidden p-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-4">
            <Link to="/" className="h-8 w-8 hover:scale-110 transition-transform duration-300">
