...
export function Simulador() {
  ...
  const [faturamento12m, setFaturamento12m] = useState<number | null>(null);
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      api
        ...
        .then((r) => setFaturamento12m(r.data.mei.faturamento_12m ?? null))
        .catch(() => null),
    ]);
  }, [id_mei]);
  ...
  const dadosForm = {
    faturamento_12m: retorno?.faturamento_12m ?? faturamento12m ?? undefined,
    ...
    <div className='w-full space-y-8 pt-3'>
      ...
      <div className='grid md:grid-cols-2 gap-6 mb-6'>
        ...
        <Card className='bg-gradient-to-r from-green-500 to-green-600 pt-6 pb-0 transform hover:scale-102 transition-all duration-300'>
          ...
          <CardContent className='bg-card p-6 rounded-b-xl h-full'>
            <p className='text-card-foreground mb-6'>
              Regime simplificado que unifica o recolhimento de até 8 tributos
              em uma única guia (DAS), com alíquotas progressivas baseadas no
              faturamento anual.
            </p>
        ...
        <Card className='bg-gradient-to-r from-blue-500 to-blue-600 pt-6 pb-0 transform hover:scale-102 transition-all duration-300'>
          ...
          <CardContent className='bg-card p-6 rounded-b-xl h-full'>
            <p className='text-card-foreground mb-6'>
              Regime onde a Receita Federal presume um percentual de lucro sobre
              o faturamento, aplicando tributos sobre essa base presumida.
            </p>
      ...
      <Card className='gap-0'>
        ...
        <CardContent className='grid md:grid-cols-3 gap-6'>
          <div className='text-center transform hover:scale-102 transition-all duration-300'>
            ...
            <p className='text-sm'>
              O volume de receitas é o principal fator determinante na escolha
              do regime.
            </p>
          </div>
          ...
          <div className='text-center transform hover:scale-102 transition-all duration-300'>
            ...
            <p className='text-sm'>
              Algumas atividades têm restrições ou tratamentos específicos em
              cada regime.
            </p>
          </div>
          ...
          <div className='text-center transform hover:scale-102 transition-all duration-300'>
            ...
            <p className='text-sm'>
              A relação entre receitas e despesas impacta diretamente na
              tributação.
            </p>
          </div>
        </CardContent>
