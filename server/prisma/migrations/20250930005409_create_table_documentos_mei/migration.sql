...
-- AddForeignKey
ALTER TABLE "public"."DocumentosMei"
ADD CONSTRAINT "DocumentosMei_id_mei_fkey" FOREIGN KEY ("id_mei") REFERENCES "public"."Mei"("id_mei") ON DELETE RESTRICT ON UPDATE CASCADE;